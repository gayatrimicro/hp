<?php 
	// var_dump($_POST);
	// exit();
 	 $fname = $_POST["fname-footer"];
 	 $lname = $_POST["lname-footer"];
 	 $phone  = $_POST["pnumber-footer"];
	 $emailid= $_POST["email-footer"];
	 $text_area= $_POST["subject-footer"];

	 // $location = $_POST["location"];

	$subject ="Health & Psychiatry Contact Form Request by " . $fname;
