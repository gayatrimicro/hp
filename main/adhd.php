...
<head>
  ...
  <meta charset="utf-8" />
  <title>ADHD | Health &amp; Psychiatry</title>
...
<div class="c-hero js-hero--full o-gutter | js-hero">
  <figure class="c-hero__bg o-cover | js-transition-hero">
          ...
          <picture>
        <source srcset="../assets/images/img/mob-adhd-banner.jpg" media="(orientation : portrait) and (max-width: 540px)">

        <img 
              src="../assets/images/img/adhd-banner.jpg" preload="metadata"
  ...
  <div class="">
    <h1 class="c-hero__title o-h1">
        ...
        <span>
          <div class="c-line c-line--2 | js-transition-line">for children and adults</div>
        </span>
  ...
  <div class="o-row o-row--small">
    ...
    We test and diagnose <br>ATTENTION DEFICIT HYPERACTIVE DISORDER (ADHD)
    </p>
  </div>
</div>        
      </div>
  ...
  <div class="o-row">
    <div class="c-img-txt__inner">
      <div class="c-img-txt__content o-content-max o-margin-top-s o-margin-bottom-s@md">
        <h3 class="o-h3 c-img-txt__title dark-teal">What is QbTest?<!--  involves a person’s emotional, psychological, and social well-being. --></h3>
        <div class="o-txt" data-scroll="staggerLinesP">
          <p>QbTest is a computer-based program that combines a test of attention ability with a movement analysis based on an infrared measurement system. Test results are assembled into a report and compared with data from a control group consisting of people who are the same sex and age as yourself. This way you can see how you react when you concentrate on a task in comparison with people who do not have ADHD. 
            <strong>QbTest is the only test in the world cleared by the FDA for this use.</strong></p><p>
            At Health and Psychiatry, we know that assessing Attention Deficit Hyperactive Disorder (ADHD) may be complicated. There is no single clinical tool that can provide all the answers. The QBTest provides objective data that, together with other information, will help your clinician assess you for Attention Deficit Hyperactive Disorder (ADHD).
      ...
      <figure class="c-img-txt__img">
        <div class="c-img-txt__img-inner o-cover o-cover--abs">
          ...
          > -->
          <img 
            src="../assets/images/img/adhd-qbtest.jpg" 
            alt=""
          >
        </div>
...
<div class="c-img-txt-2 c-img-txt-2--block c-img-txt-2--reverse o-gutter-l o-padding-bottom-s u-bg-white">
  <div class="o-row">
    <div class="c-img-txt-2__grid">
      ...
      <div class="c-content c-content--max@sm">
        <h3 class="c-content__title o-h3">
          How should QbTest be used?
        </h3>
        <div class="c-content__text o-txt" data-scroll="staggerLinesP">
          <p>At Health and Psychiatry, we know that assessing Attention Deficit Hyperactive Disorder (ADHD) may be complicated. There is no single clinical tool that can provide all the answers. The QBTest provides objective data that, together with other information, will help your clinician assess you for Attention Deficit Hyperactive Disorder (ADHD).</p>


        </div><br><br>
        <h3 class="o-h3 c-img-txt__title dark-teal">How is a QbTest performed?<!--  involves a person’s emotional, psychological, and social well-being. --></h3>
        <div class="o-txt" data-scroll="staggerLinesP">
          <p>QThe test equipment consists of an infrared camera, a head-band with an infrared marker attached to it and a responder button.<br>
      ...
      <div class="c-img-txt-2__img c-img-txt-2__img--1">
        <figure class="o-cover o-cover--rel">
          <img 
            src="../assets/images/img/adhd-qbtest-two.jpg" alt=""
...
<div class="c-img-txt-2 c-img-txt-2--block c-img-txt-2--reverse o-gutter-l o-padding-bottom-s u-bg-white">
  <div class="o-row">
    <div>
      ...
      <div >
        <h3 class="c-content__title o-h3">
         Are you considering taking the QbTest?
        </h3>
        <div class="c-content__text o-txt" data-scroll="staggerLinesP">
            <p>For too long, there have been misconceptions about the condition, what it is, how it affects people, and how it should be treated. If you suspect that you or a loved one may have ADHD. Come in today and learn more about QbTest and how we can assist you in your journey to a more prosperous and productive life!
            </p>
    ...
    <br><br><br><br><br>
              ...
              Here at Health and Psychiatry, all testing and the<br>
                assessment can be completed the same day.
              </h3>
...
<div class="c-communities o-gutter-s o-padding h-100vh">
  ...
  >
    <img src="../assets/images/img/tempa-2.jpg" alt="">
  </figure>
