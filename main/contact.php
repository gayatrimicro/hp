         ...
         <article data-router-view="contact">
            <div class="o-page__mask | js-page__mask">
               <div class="js-smooth-section">
                  <div class="c-hero c-hero--small o-gutter | js-hero">
                     <figure class="c-hero__bg o-cover | js-transition-hero">
                        <picture>
                           <source srcset="../assets/images/img/contact-banner.jpg" media="(orientation : portrait) and (max-width: 540px)">
                           <img 
                              src="../assets/images/img/contact-banner.jpg"
                     ...
                     <div class="">
                        <h1 class="c-hero__title o-h1">
                           ...
                           <span>
                              <div class="c-line c-line--2 | js-transition-line"> Mental Health Care Providers</div>
                           </span>
                        </h1>
                     </div>
                  </div>
                  <div class="c-intro o-gutter-s o-padding-s u-bg-white">
                     <div class="o-row o-row--small">
                        <p class="c-intro__text o-h3 u-color-black" data-scroll="staggerLines"  style="text-align: center;">
                           
                          We accept all major insurance and Medicare.<br>
                          If you have an emergency or require immediate attention,<br> please call 911.<br>
            ...
            <div class="js-smooth-section">
               <div class="c-communities o-gutter-s o-padding">
                  <figure 
                     ...
                     >
                     <img src="../assets/images/img/tempa-1.jpg" alt="">
                  </figure>
                  <div class="c-communities__inner u-bg-white o-gutter">
                     <button type="button" class="c-communities-close [ js-communities__close js-communities-close">
                        <div class="c-communities-close__line">
                           <div class="js-communities-close__line"></div>
                        </div>
                        <div class="c-communities-close__line">
                           <div class="js-communities-close__line"></div>
                        </div>
                     </button>
                     <h3 class="c-communities__title o-h3 o-sans u-txt-center@sm | js-communities-select-stagger">Select a location</h3>
                     <div class="c-communities-select | js-communities-select-stagger">
                        <i class="c-communities-select__icon">
                        ...
                        <select class="c-communities-select__dropdown | js-communities-select" style="border: none;">
                           <option value="Select community" selected disabled>Select location</option>
                           <option value="troubadour-golf-and-field-club">Oldsmar, FL</option>
                           <option value="vaquero-golf-club">Port Richey, FL</option>
                           <option value="yellowstone-club">Wesley, FL</option>
                        </select>
                     </div>
                     <ul class="c-communities-list">
                        
                        <li class="c-communities-item o-gutter | js-communities-item" data-slug="troubadour-golf-and-field-club">
                           <h3 class="c-communities-item__title o-h3 u-txt-center@sm | js-communities-stagger">Oldsmar, FL</h3>
                           <p class="c-communities-item__location | js-communities-stagger">
                              <a href="https://goo.gl/maps/Q2f7qyaCVqwcS5348" target="_blank" rel="noreferrer">3919, Tampa Rd, Oldsmar, FL 34677</a>
                           </p>
                           
                           <p class="c-communities-item__phone | js-communities-stagger">
                              <a href="tel:727-733-6111">727-733-6111</a>
                           </p>
                           <div class="c-communities-item__ctas | js-communities-stagger">
                              <button type="button" class="c-communities-item__back c-btn | js-communities__close" target="_blank" rel="noreferrer">
                                 ...
                                 <div class="c-btn__text c-btn__text--top | js-btn__text--top">Go Back</div>
                                 <div class="c-btn__text c-btn__text--bottom | js-btn__text--bottom" aria-hidden="true">Go Back</div>
                              </button>
                           </div>
                        </li>
                        <li class="c-communities-item o-gutter | js-communities-item" data-slug="vaquero-golf-club">
                           <h3 class="c-communities-item__title o-h3 u-txt-center@sm | js-communities-stagger">Port Richey, FL</h3>
                           <p class="c-communities-item__location | js-communities-stagger">
                              <a href="https://goo.gl/maps/3otNBrrMj9Q1kbDD7" target="_blank" rel="noreferrer">7011, Ridge Road, Port Richey, FL 34668</a>
                           </p>
                         
                           <p class="c-communities-item__phone | js-communities-stagger">
                              <a href="tel:(727) 312-3883">(727) 312-3883</a>
                           </p>
                           <div class="c-communities-item__ctas | js-communities-stagger">
                              <button type="button" class="c-communities-item__back c-btn | js-communities__close" target="_blank" rel="noreferrer">
                                 <div class="c-btn__borders">
                        ...
                        <li class="c-communities-item o-gutter | js-communities-item" data-slug="yellowstone-club">
                           <h3 class="c-communities-item__title o-h3 u-txt-center@sm | js-communities-stagger">Wesley, FL</h3>
                           <p class="c-communities-item__location | js-communities-stagger">
                              <a href="https://goo.gl/maps/mPQV2LBUMqqqchoi7" target="_blank" rel="noreferrer">2321, Crestover Lane, Wesley Chapel, FL 33544</a>
                           </p>
                           <p class="c-communities-item__email | js-communities-stagger">
                              <a href="mailto:info@wesleychapelpsychiatry.com">info@wesleychapelpsychiatry.com</a>
                           </p>
                           <p class="c-communities-item__phone | js-communities-stagger">
                              <a href="tel:812.576.8133">812.576.8133</a>
                           </p>
                           <div class="c-communities-item__ctas | js-communities-stagger">
                              <button type="button" class="c-communities-item__back c-btn | js-communities__close" target="_blank" rel="noreferrer">
                                 <div class="c-btn__borders">
               ...
               <div class="c-headquarters o-gutter-s o-padding-s u-bg-white">
                  <div class="o-row">
                     <h3 class="o-h3 u-txt-center@sm" style="color: #6ba5a9;">
                        Call to make an appointment. 
                     </h3>
                     <div class="c-headquarters__inner">
                        <article class="c-headquarter o-margin-top-xs">
                           <h1 class="o-h4 c-headquarter__title o-sans">Oldsmar, FL:</h1>
                           <ul class="c-headquarter__contacts">
                              <li class="c-headquarter__item">
                                 Phone: <a href="tel:727-733-6111">727-733-6111</a>
                              </li>
                             
                           </ul>
                        </article>
                        <article class="c-headquarter o-margin-top-xs">
                           <h1 class="o-h4 c-headquarter__title o-sans">Port Richey, FL:</h1>
                           <ul class="c-headquarter__contacts">
                              <li class="c-headquarter__item">
                                 Phone: <a href="tel:(727) 312-3883">(727) 312-3883</a>
                              </li>
                             
                           </ul>
                        </article>
                        <article class="c-headquarter o-margin-top-xs">
                           <h1 class="o-h4 c-headquarter__title o-sans">Wesley, FL:</h1>
                           <ul class="c-headquarter__contacts">
                              <li class="c-headquarter__item">
                                 Phone: <a href="tel:812.576.8133">812.576.8133</a>
                              </li>
                              <li class="c-headquarter__item">
                                 <a href="mailto:info@wesleychapelpsychiatry.com">info@wesleychapelpsychiatry.com</a>
                              </li>
            ...
            <div class="c-orientation__inner">
               ...
               <div class="c-orientation__icon">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 352.03 329.24">
                     ...
                     <circle class="cls-1" cx="141.2" cy="217.82" r="5.37"/>
                     <path class="cls-1" d="M234 195.8h7.8a3 3 0 1 0 0-6H234a3 3 0 1 0 0 6z" transform="translate(-96.68 -84.37)"/>
                     <path class="cls-1" d="M330 242.11h-54.6v-45.42a16 16 0 0 0-16-16h-43a16.05 16.05 0 0 0-16 16v104.6a16 16 0 0 0 16 16h43a16.53 16.53 0 0 0 2.12-.14 3.42 3.42 0 0 0 .46 0h68a15 15 0 0 0 15-15v-45.02A15 15 0 0 0 330 242.11zm-10 6v63.19h-48.06a16 16 0 0 0 3.49-10v-53.23zm-113.72-42.45h63.2v81.73h-63.2zm10.08-19h43a10.1 10.1 0 0 1 10.08 10.08v3h-63.2v-3a10.09 10.09 0 0 1 10.12-10.13zm-10.08 114.63v-7.94h63.2v7.94a10.1 10.1 0 0 1-10.08 10.08h-43a10.09 10.09 0 0 1-10.12-10.08zm132.82.9a9.08 9.08 0 0 1-9.07 9.07h-4v-63.19h4a9.07 9.07 0 0 1 9.07 9.06z" transform="translate(-96.68 -84.37)"/>
                     <path class="cls-1" d="M332.88 272.78a3 3 0 0 0-3 3v7.8a3 3 0 1 0 5.95 0v-7.8a3 3 0 0 0-2.95-3zM283.93 204.16h20a13.76 13.76 0 0 1 13.74 13.74v8.1l-5.36-5.36a3 3 0 1 0-4.22 4.21l10.45 10.45a3 3 0 0 0 2.11.87 2.94 2.94 0 0 0 2.1-.87l10.45-10.45a3 3 0 1 0-4.2-4.25l-5.38 5.4v-8.1a19.73 19.73 0 0 0-19.7-19.7h-20a3 3 0 0 0 0 6z" transform="translate(-96.68 -84.37)"/>
                     <path d="M421.73 244.33a3.71 3.71 0 1 1-5.49-5l10.12-11.13c-10.19-76-75.46-134.83-154.22-134.83-80.26 0-146.52 61.07-154.75 139.18l5.94-5.52a3.64 3.64 0 1 1 5 5.33l-11.64 10.82c-.07 1.93-.12 3.86-.12 5.81 0 85.81 69.81 155.62 155.62 155.62S427.75 334.8 427.75 249q0-5.48-.38-10.86z" transform="translate(-96.68 -84.37)" fill="none"/>
                     <path class="cls-1" d="M447.49 237.85l-12.25-11.14c-10.9-80.27-79.89-142.34-163.1-142.34-85.07 0-155.27 64.86-163.76 147.72l-5.4-5.81a3.64 3.64 0 0 0-5.33 4.95l10 10.79c-.1 2.31-.16 4.63-.16 7 0 90.77 73.85 164.62 164.62 164.62S436.75 339.76 436.75 249q0-5.66-.39-11.22l6.13 5.57a3.71 3.71 0 1 0 5-5.49zM272.14 404.61c-85.81 0-155.62-69.81-155.62-155.62 0-2 0-3.88.12-5.81l11.64-10.82a3.64 3.64 0 1 0-5-5.33l-5.94 5.52c8.23-78.11 74.49-139.18 154.75-139.18 78.76 0 144 58.82 154.22 134.83l-10.12 11.13a3.71 3.71 0 1 0 5.49 5l5.64-6.2q.38 5.38.38 10.86c.05 85.81-69.7 155.62-155.56 155.62z" transform="translate(-96.68 -84.37)"/>
                  </svg>
               </div>
            </div>
         </div>
