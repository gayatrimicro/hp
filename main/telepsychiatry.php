...
<head>
  ...
  <meta charset="utf-8" />
  <title>Tele-Psyciatry | Health &amp; Psychiatry</title>
...
<div class="c-hero js-hero--full o-gutter | js-hero">
  <figure class="c-hero__bg o-cover | js-transition-hero">
          ...
          <picture>
        <source srcset="../assets/images/img/mob-telepsy-banner.jpg" media="(orientation : portrait) and (max-width: 540px)">

        <img 
              src="../assets/images/img/telepsy-banner.jpg" preload="metadata"
  ...
  <div class="">
    <h1 class="c-hero__title o-h1">
        ...
        <span>
          <div class="c-line c-line--2 | js-transition-line">from anywhere</div>
        </span>
  ...
  <div class="o-row">
    <div class="c-img-txt__inner">
      <div class="c-img-txt__content o-content-max o-margin-top-s o-margin-bottom-s@md">
        <h3 class="o-h3 c-img-txt__title dark-teal">What is Telepsychiatry?<!--  involves a person’s emotional, psychological, and social well-being. --></h3>
        <div class="o-txt" data-scroll="staggerLinesP">
          <p>Telepsychiatry is an innovative practice in healthcare that applies telemedicine to the field of psychiatry. It generally refers to the delivery of psychiatric assessment and care via telecommunications technology, usually videoconferencing.</p>

          <p>There’s no question that a lack of access to proper psychiatric care is one of the biggest struggles of the American public health system. While psychiatry is traditionally one of the branches of medicine least affected by technological change, recent advances in videoconferencing technology have proven effective in bringing professional mental health care to underserved populations.</p>

          <p>This practice known as telepsychiatry is one of the most promising developments in the fight to provide more patient-centered, affordable and effective interventions for individuals who need psychiatric care.</p>
        </div>
      ...
      <figure class="c-img-txt__img">
        <div class="c-img-txt__img-inner o-cover o-cover--abs">
          ...
          > -->
          <img 
            src="../assets/images/img/telepsy.jpg" 
            alt=""
          >
        </div>
    ...
    <div class="c-img-txt-2__grid">
      ...
      <div class="c-img-txt-2__content c-content c-content--max@sm">
        ...
        <div class="c-content__text o-txt" data-scroll="staggerLinesP">
          <p>What does telepsychiatry look like for a typical patient? In most cases, the process of getting help changes little. Patients first visit their primary care provider or contact a mental health clinic in their area to discuss their concerns. The individual will then be provided with a referral to see an Health &amp; Psychiatry Telehealth psychiatrist or mental health specialist, and the clinic will arrange a time for a one-on-one videoconference with the specialist.</p>

          <p>The content of the appointment will be exactly the same as if it were taking place in person. Our doctors can discuss the issue in detail, make a treatment plan and even prescribe medicine through telepsychiatry. Any follow-up appointments or further referrals can be conducted much in the same way, saving the patient considerable travel time and related expenses.</p>
      ...
      <div class="c-img-txt-2__img c-img-txt-2__img--1">
        <figure class="o-cover o-cover--rel">
          <img 
            src="../assets/images/img/telepsy-exp.jpg" alt=""
        ...
        <figure class="o-cover o-cover--rel">
          <div class="c-hero-slide | js-hero-slide">
            <iframe width="550" height="355"
              src="https://www.youtube.com/embed/PUNz--gMyLM">
            </iframe>
          </div>
        </figure>
      </div>
...
<div class="c-communities o-gutter-s o-padding h-100vh">
  ...
  >
    <img src="../assets/images/img/tempa-3.jpg" alt="">
  </figure>
</section> 
